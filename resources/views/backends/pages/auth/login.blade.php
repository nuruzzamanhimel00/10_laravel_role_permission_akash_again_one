@extends("backends.pages.auth.layouts.auth_master")
            ...
            <form method="POST" action="{{ route('admin.login.submit') }}">
                ...
                <div class="login-form-body">
                    ...
                    <div class="form-gp">
                        ...
                        <input type="text" id="exampleInputEmail1" class=" @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus >
                        <i class="ti-email"></i>
